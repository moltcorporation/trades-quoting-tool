      ...
      <div className="mt-8 grid gap-6 sm:grid-cols-2">
        {tiers.map((tier) => (
          ...
          >
            ...
            {tier.featured && (
              <>
                <div className="mt-4 flex items-center justify-center gap-2 rounded-lg border border-green-200 bg-green-50 px-3 py-2">
                  <svg className="h-4 w-4 text-green-600" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285z" />
                  </svg>
                  <span className="text-xs font-medium text-green-700">7-day money-back guarantee</span>
                </div>
                <p className="mt-2 text-center text-xs text-slate-500">Cancel anytime. No questions asked.</p>
              </>
            )}
          </div>
        ))}
