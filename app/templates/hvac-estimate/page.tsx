...
export const metadata: Metadata = {
  ...
  description:
    "Free hvac estimate template with line items, labor, parts, and tax. Or skip the template — create professional estimates instantly with TradeQuote.",
  keywords: [
    "hvac estimate template",
    "HVAC tech estimate template free",
    "hvac quote template",
...
const sampleLineItems = [
  { description: "Remove old unit & install new (labor)", amount: "$1,500" },
  { description: "Carrier 3-ton condenser (parts)", amount: "$2,800" },
  { description: "Refrigerant line set & electrical", amount: "$350" },
  { description: "Disposal of old unit", amount: "$150" },
];

const faqItems = [
  {
    question: "What should a hvac estimate include?",
    answer: "A professional hvac estimate should include: your business name and contact info, client name and address, detailed description of work, line items for labor and materials separately, subtotal, tax, total, payment terms, and an expiration date (usually 30 days).",
  },
  {
    question: "How do I price a hvac job?",
    answer: "Most HVAC techs charge $85–$175/hour for labor plus materials with a 15–30% markup. For fixed-price jobs, estimate hours needed, add materials cost, include markup, and add a 10% contingency for unexpected issues.",
  },
  {
    question: "Should I give free estimates?",
    answer: "For standard residential jobs (thermostat install, filter change, minor repair), free estimates are expected and help you win work. For complex jobs requiring on-site inspection (full system replacement, ductwork), charging $50–$150 for a detailed estimate is reasonable.",
  },
];
    ...
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900">
      ...
      <main className="mx-auto max-w-3xl px-6 py-16">
        ...
        <p className="mt-4 text-lg text-slate-600">
          Use this template to create professional hvac estimates. Or skip the copy-paste — TradeQuote lets you build, send, and track estimates in minutes.
        </p>

        {/* Sample estimate */}
        <section className="mt-10">
          <h2 className="text-xl font-bold">What a professional hvac estimate looks like</h2>
          <div className="mt-4 rounded-xl border border-slate-200 bg-white overflow-hidden">
            <div className="bg-slate-900 px-6 py-4 text-white">
              <p className="font-bold">Mike&apos;s HVAC LLC</p>
            ...
            <div className="px-6 py-5">
              ...
              <p className="text-sm text-slate-500 mt-1">Job: AC unit replacement</p>
              <table className="w-full mt-4 text-sm">
                ...
                <tbody>
                  ...
                  <tr className="text-slate-500"><td className="py-2 text-right" colSpan={2}>Subtotal: $4,800</td></tr>
                  <tr className="text-slate-500"><td className="py-1 text-right" colSpan={2}>Tax (8%): $384</td></tr>
                  <tr className="font-bold text-lg"><td className="py-2 text-right" colSpan={2}>Total: $5,184</td></tr>
                </tbody>
              </table>
            </div>
          </div>
