    ...
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900">
      ...
      <header className="border-b border-slate-200 bg-white">
        <div className="mx-auto flex max-w-4xl items-center justify-between px-6 py-4">
          ...
          <Link href="/register?trade=plumber" className="rounded-lg bg-slate-900 px-4 py-2 text-sm font-medium text-white hover:bg-slate-800">Create free estimate</Link>
        </div>
      </header>
      ...
      <main className="mx-auto max-w-3xl px-6 py-16">
        ...
        <section className="mt-12">
          <TemplateDownloadForm config={templateConfigs["plumbing-estimate"]} />
        </section>
        {/* What to include */}
        <section className="mt-12">
        ...
        <section className="mt-12 rounded-xl bg-slate-900 p-10 text-center">
          ...
          <Link href="/register?trade=plumber" className="mt-6 inline-block rounded-lg bg-amber-500 px-6 py-3 text-sm font-bold text-slate-900 hover:bg-amber-400">
